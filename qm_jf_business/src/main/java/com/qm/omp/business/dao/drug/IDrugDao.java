...
public interface IDrugDao {
	 ...
	 * @return
	 */
	List<Map<String, Integer>> getCheckedDrugList(
	...
	void saveUserDrug(@Param(value = "userId") int userId,
			@Param(value = "drugId") int drugId);
	...
	Drug getBeanByBalanceId(@Param(value = "fDrugId") Integer fDrugId);

	void addNumber(@Param(value = "fDrugId") Integer fDrugId,
			@Param(value = "fNumber") Integer fNumber);
	
	void addNumberAndNumberBak(@Param(value = "fDrugId") Integer fDrugId,
			@Param(value = "fNumber") Integer fNumber);
	...
	Map<String, Object> userDrugOnly_showPrice(
