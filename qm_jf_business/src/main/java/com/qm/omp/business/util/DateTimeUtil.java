...
public class DateTimeUtil
{
     ...
     * 日期类型从一个类型转为另一个类型
     * @param fTime
     * @param sourcePattern  原类型
     * @param toPattern	转换后的类型
     * @return
     */
    public static String translateDateToDate(String fTime,String sourcePattern, String toPattern){
