...
<body class="easyui-layout">
	...
	<div data-options="region:'center',border:false" style="background-color:#FFF; padding:10px;">
		...
		<input type="hidden" name="reqMethod" id="reqMethod" value="save" />
		<input type="hidden" name="fDrugIntroId" id="fDrugIntroId" />
		<input type="hidden" name="fDrugPrinterId" id="fDrugPrinterId" />
		<input type="hidden" name="fDepartmentId" id="fDepartmentId" />
		<table cellpadding="0" cellspacing="0" class="formTable" width="100%">
			...
			<tr>
					...
					<td width="35%">
						<input id="fXqTc" name="fXqTc" type="text" autofocus="autofocus" class="easyui-validatebox" data-options="required:true,validType:'intOrFloat'" />
					</td>
					<th width="15%">
						<label>大区提成：</label>
					</th>
					<td width="35%">
						<input id="fDqTc" name="fDqTc" type="text" autofocus="autofocus" class="easyui-validatebox" data-options="required:true,validType:'intOrFloat'" />
					</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="3">
					<textarea id="fIntro" name="fIntro" rows="3" cols="100"></textarea>
				</td>
			</tr>
		</table>
	</div>
