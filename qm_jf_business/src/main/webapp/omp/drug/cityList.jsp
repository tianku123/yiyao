...
<body class="easyui-layout" id="filter">
		<div data-options="region:'north',border:false" style="height:77px;">
		  ...
		  <div class="searchColumn">
			<div class="keySearch">
				客户区域名称： <input type="search" placeholder="客户区域名称" id="fUserCode" onkeyup="enterEvent(event, 'merchantUserInfoComponent.userDataGrid.formQry()');"/>
	...
	var merchantUserInfoComponent = {
		...
		init : function() {
			...
			var columns = [ 
				...
				{field : 'fName',title : '区域名称',width :100,align:'center'}, 
			...
			toolbars.urls = {
				"ADD" : GLOBAL_INFO.CONTEXTPATH
						+ "/omp/drug/addCity.jsp",
				"EDIT" : GLOBAL_INFO.CONTEXTPATH
						+ "/omp/drug/editCity.jsp"
			};
			toolbars.newBtns = [
		...
		exportA : function(){
			...
			location.href = "${ctx}system/exportCity.do";
		} 
	}
