	...
	<div data-options="region:'center',border:false" style="background-color:#FFF; padding:10px;">
		<table cellpadding="0" cellspacing="0" class="formTable" width="100%">
			<tr>
				...
				<td width="80%">
					<input id="fExpressName" name="fExpressName" type="text" autofocus="autofocus" class="easyui-validatebox" data-options="required:true" />
				</td>
			...
			<tr>
				...
				<td width="80%">
					<input id="fExpressId" name="fExpressId" type="text" autofocus="autofocus" class="easyui-validatebox" data-options="required:true" />
				</td>
			...
			<tr>
				...
				<td width="80%">
					<textarea id="fShipperIntro" name="fShipperIntro" rows="10" cols="80"></textarea>
				</td>
...
<script>
	...
	var merchantUserInfoComponent = {
		...
		comit : function() {
			var fExpressName = $("#fExpressName").val();
			var fExpressId = $("#fExpressId").val();
			var fShipperIntro = $("#fShipperIntro").val();
			
			if(!$("#fExpressName").validatebox('isValid')){
				return;
			}
			if(!$("#fExpressId").validatebox('isValid')){
				return;
			}
			ajaxTools.singleReq({
				data : {
					...
					"fId" : "${param.fId}",
					"fState" : "${param.fState}",
					"fShipperIntro" : fShipperIntro,
					"fExpressName" : fExpressName,
					"fExpressId" : fExpressId
				},
				success : function(ret) {
