	...
	var merchantUserInfoComponent = {
		...
		init : function() {
			...
			var columns = [ 
				...
				{field : 'fXqTc',title : '小区主管提成',width :100,align:'center',
					formatter: function(value,row,index){
						return value+"元";
					}
				},
				{field : 'fXqTc_Money',title : '小区主管提成金额',width :100,align:'center',
					formatter: function(value,row,index){
						return value+"元";
					}
				},
				{field : 'fDqTc',title : '大区主管提成',width :100,align:'center',
					formatter: function(value,row,index){
						return value+"元";
					}
				},
				{field : 'fDqTc_Money',title : '大区主管提成金额',width :100,align:'center',
					formatter: function(value,row,index){
						return value+"元";
					}
				}
