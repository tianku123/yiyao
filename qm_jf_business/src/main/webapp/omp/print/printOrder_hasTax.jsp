		...
		success : function(ret) {
			if(ret&&ret.a==GLOBAL_INFO.SUCCESS_CODE) {
				...
				for(var i=0; i<arr.length; i++){
					...
					trHtml += "<td></td>";
					trHtml += "<td> " + arr[i]['F_KAIPIAO_PRICE'] + " </td>";
					trHtml += "<td> " + arr[i]['F_MONEY_KAIPIAO'] + " </td>";
					/* if(typeof(arr[i]['F_WAREHOUSE_NAME']) == 'undefined'){
						trHtml += "<td></td>";
					}else{
						trHtml += "<td> " + arr[i]['F_WAREHOUSE_NAME'] + " </td>";
					} */
					trHtml += "</tr>";
				}
