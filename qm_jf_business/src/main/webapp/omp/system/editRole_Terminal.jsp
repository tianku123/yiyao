		...
		<div data-options="region:'center',border:false" style="background-color:#FFF; padding:10px;">
			...
			<table cellpadding="0" cellspacing="0" class="formTable" width="100%">
				<tr>
					...
					<td width="35%"><input id="fRoleCode" value=${param.roleCode } name="fRoleCode" type="text" autofocus="autofocus" disabled="disabled"/></td>
...
<script>
	...
	var merchantRoleInfoComponent = {
		comit : function() {
			//获取参数
			var fRoleCode = trimBlankFunc($("#fRoleCode").val());
			var fRoleName = trimBlankFunc($("#fRoleName").val());
