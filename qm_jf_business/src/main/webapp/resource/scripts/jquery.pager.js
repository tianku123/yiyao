...
(function($) {
    ...
    $.fn.pager = function(options) {
        ...
        // empty out the destination element and then render out the pager with the supplied options
            ...
            $(".pages input[type='text']").keyup(function(event){
            	var keyCode;
                var reg = /^[0-9]*$/;
            	if ($.browser.mozilla)
            	{
            	...
            	if(keyCode == 13)
                {
            	    ...
            	    if(reg.test(i))
            	    {
            	    	if(i > 0 && i <= parseInt(options.pagecount)){
                	    	options.buttonClickCallback(i);
                	    }
            	    }
                } 
            });
            ...
            $(".pages input[type='button']").click(function(){
            	var reg = /^[0-9]*$/;
            	var i = parseInt($(".pages input[type='text']").val());
        	    if(reg.test(i))
        	    {
        	    	if(i > 0 && i <= parseInt(options.pagecount)){
            	    	options.buttonClickCallback(i);
            ...
            $(".pages input[type='text']").keyup(function(){     
                var tmptxt=$(this).val();     
    ...
    function renderpager(pagenumber, pagecount, buttonClickCallback) {
        ...
        $pager.append(renderInput(pagenumber, pagecount, buttonClickCallback));
        return $pager;
    }
    ...
    {
    	var $Input = $('<input type="text" class="text" /><input type="button" class="button" value="确定" />');
    	return $Input;
    }
